...
export default class Example extends Component {
  ...
  render() {
    ...
    return (
      <Animated.View style={[styles.container, {borderWidth: divide(this._trans, 5)}]}>
        <Animated.Text
          style={[
            styles.box,
            {
        ...
        >
          sample text is getting bigger and bigger more and moar staph staph stophhh
        </Animated.Text>
        <Animated.Text
          style={[
            styles.text,
            {
              ...
              fontStyle: cond(greaterOrEq(this._trans, 190), 'normal', 'italic'),
            },
          ]}
        >
          aesthetic
