    ...
    this.handlePan = event([
      {
        nativeEvent: ({translationX: x, translationY: y, state}) =>
          block([
            ...
            cond(eq(state, State.END), [set(offsetX, add(offsetX, x)), set(offsetY, add(offsetY, y))]),
          ]),
      },
    ]);
    ...
    this.handleRotate = event([
      {
        nativeEvent: ({rotation: r, state}) =>
          block([set(this.R, add(r, offsetR)), cond(eq(state, State.END), [set(offsetR, add(offsetR, r))])]),
      },
    ]);
