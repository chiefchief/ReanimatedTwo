...
export function MainScreenItem({item, onPressItem, screens}: MainScreenItemProps): React.ReactElement {
  const {key} = item;
  return (
...
function LaunchReanimated1({setUseRea2}: {setUseRea2: (useRea2: boolean) => void}) {
  return (
    <>
      <ItemSeparator />
...
function App(): React.ReactElement {
  ...
  return <NavigationContainer>{useRea2 ? Reanimated2(setUseRea2) : Reanimated1(setUseRea2)}</NavigationContainer>;
}
