...
type onItemPressFn = <T>(animatedRef: RefObject<T>, item: ExampleImage, svs: ActiveExampleImageProperties) => void;
function ImageList({images, onItemPress}: {images: ExampleImage[]; onItemPress: onItemPressFn}) {
  return (
...
function ImageTransition({activeImage, onClose}: {activeImage: ActiveExampleImage; onClose: () => void}) {
