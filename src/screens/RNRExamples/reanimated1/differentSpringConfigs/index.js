...
const {block, set, cond, eq, spring, startClock, Value, Clock, SpringUtils} = Animated;
...
class Snappable extends Component {
  ...
  render() {
    ...
    return <Animated.View style={{transform: [{translateX: this._transX}]}}>{children}</Animated.View>;
  }
}
