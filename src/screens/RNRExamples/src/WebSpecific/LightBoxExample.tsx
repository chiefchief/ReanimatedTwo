...
type onItemPressFn = (imageRef: RefObject<Component>, item: ExampleImage, sv: Animated.SharedValue<number>) => void;
...
function LightboxExample(): React.ReactElement {
  ...
  function onItemPress(imageRef: RefObject<Component>, item: ExampleImage, sv: Animated.SharedValue<number>) {
