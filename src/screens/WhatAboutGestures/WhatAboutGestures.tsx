...
const SIZE = 80;
export const WhatAboutGestures: React.FC = () => {
  ...
  const {followX: blueFollowX, followY: blueFollowY, rStyle: rBlueCircleStyle} = useFollowAnimatedPosition({
    x: translateX,
    y: translateY,
  });

  const {followX: redFollowX, followY: redFollowY, rStyle: rRedCircleStyle} = useFollowAnimatedPosition({
    x: blueFollowX,
    y: blueFollowY,
  });
