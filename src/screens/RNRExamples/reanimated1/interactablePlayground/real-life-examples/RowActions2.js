...
import {StyleSheet, View, Image, Text, TouchableOpacity, Dimensions, Slider} from 'react-native';
  ...
  render() {
    return (
      <View style={{backgroundColor: '#ceced2'}}>
        ...
        >
          <View style={{left: 0, right: 0, height: 75, backgroundColor: 'white'}}>{this.props.children}</View>
        </Interactable.View>
      </View>
    );
  }
