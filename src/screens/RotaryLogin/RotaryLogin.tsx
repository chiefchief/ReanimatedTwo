/**
 *
 * https://youtu.be/Th6WxfhZsAM
 *
 * https://github.com/wcandillon/can-it-be-done-in-react-native/tree/master/playground/src/RotaryLogin
 *
 */
...
import Quadrant, {STROKE_WIDTH, RADIUS, center, DIGITS, PADDING} from './Quadrant';
...
const Digit = ({cx, cy, i, theta}: DigitProps) => {
  ...
  return <AnimatedCircle key={i} cx={cx} cy={cy} r={STROKE_WIDTH / 2 - PADDING} fill="white" animatedProps={props} />;
};

const RotaryLogin: React.FC = () => {
