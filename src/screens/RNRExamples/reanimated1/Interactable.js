...
class Interactable extends Component {
  ...
  constructor(props) {
    ...
    const handleStartDrag =
      props.onDrag && call([target.x, target.y], ([x, y]) => props.onDrag({nativeEvent: {x, y, state: 'start'}}));
    ...
    const trans = (axis, vaxis, lowerBound, upperBound) => {
      ...
      const wrapStep = props.dragEnabled ? cond(props.dragEnabled, step, [set(dragging, 1), stopClock(clock)]) : step;
